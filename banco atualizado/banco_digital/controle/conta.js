...
const conta_get = (req, res) => {
    let string = "select * from tb_conta where id_cliente = " + req.params.id;
    con.query(string, (err, result) => {
        res.json(result)
    })
}

const conta_nr_get = (req, res) => {
    let string = "select * from tb_conta where numero_conta = " + req.params.nr_conta;
    con.query(string, (err, result) => {
        res.json(result)
    })
}
...
module.exports = {
    conta_get,conta_nr_get, conta_post, conta_update, conta_delete
}